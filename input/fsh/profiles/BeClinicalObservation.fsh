...
* extension contains https://www.ehealth.fgov.be/standards/fhir/core/StructureDefinition/be-ext-recorder named recorder 1..1
...
* extension[recorder]
  ...
  * valueReference only Reference (BePatient or BePractitioner or BePractitionerRole or BeOrganization or CareTeam or RelatedPerson )
