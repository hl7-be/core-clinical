...
* patient 1..1 Reference(BePatient) "Subject of the observation" """The patient or subject to whom the observation applies."""
...
* specimen 0..* Reference(BeSpecimen) "Specimen related to the observation" """Specimens that are related to the observation, such as blood samples or tissue samples."""
