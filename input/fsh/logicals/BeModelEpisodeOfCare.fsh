...
* period 1..1 Period "The period between the moment the resource is created to group the provided care and the moment it ends, when the reason for its creation disappears or the goal is reached"
