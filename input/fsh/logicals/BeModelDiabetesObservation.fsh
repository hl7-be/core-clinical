Logical: BeModelObservationDiabetes
Parent: BeModelClinicalObservation
...
// * ObservationPeriod 1..1 Period "Date or observation period (e.g. 27/11/2023) (DateTime format)"
...
// * Category 1..* CodeableConcept "698472009 “Glucose monitoring” (FR) (invariant)See VS_Obs_Dia_Category " 
