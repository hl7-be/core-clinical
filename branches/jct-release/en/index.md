...
* [FHIRDeviceStatusReason](http://terminology.hl7.org/7.3.0/CodeSystem-device-status-reason.html): [BeModelDevice](StructureDefinition-BeModelDevice.md) and [DeviceStatusReasonVS](ValueSet-DeviceStatusReasonVS.md)
