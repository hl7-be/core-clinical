# BeExtBodyTopography - Clinical Core v1.2.0
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.fhir.be.core-clinical|current/StructureDefinition/StructureDefinition-be-ext-body-topography.json)
...
```json
{
  ...
  "status" : "active",
  "date" : "2026-06-01T12:28:42+00:00",
