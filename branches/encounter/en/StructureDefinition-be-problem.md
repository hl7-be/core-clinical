# BeProblem - Clinical Core v1.2.0
...
* Refer to this Profile: [BeDeviceUseStatement](StructureDefinition-be-device-use-statement.md) and [BeEncounter](StructureDefinition-be-encounter.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.fhir.be.core-clinical|current/StructureDefinition/StructureDefinition-be-problem.json)
