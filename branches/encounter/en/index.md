...
* Parameter: system-version
  * Value: [SCT BE vhttp://snomed.info/sct/11000172109/version/20260715](http://snomed.info/sct/11000172109/version/20260715)
...
* [Condition Clinical Status Codes](http://terminology.hl7.org/7.4.0/CodeSystem-condition-clinical.html): [BeModelProblem](StructureDefinition-BeModelProblem.md)
* [ConditionVerificationStatus](http://terminology.hl7.org/7.4.0/CodeSystem-condition-ver-status.html): [BeModelProblem](StructureDefinition-BeModelProblem.md)
* [FHIRDeviceStatusReason](http://terminology.hl7.org/7.4.0/CodeSystem-device-status-reason.html): [BeModelDevice](StructureDefinition-BeModelDevice.md) and [DeviceStatusReasonVS](ValueSet-DeviceStatusReasonVS.md)
