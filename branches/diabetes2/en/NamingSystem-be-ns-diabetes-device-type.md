# be-ns-diabetes-device-type - Clinical Core v1.1.0
...
```json
{
  ...
  "extension" : [{
    ...
    "valueUri" : "https://www.ehealth.fgov.be/standards/fhir/core-clinical/NamingSystem/be-ns-diabetes-device-type"
  },
  {
  ...
  "uniqueId" : [{
    "type" : "uri",
    "value" : "https://www.ehealth.fgov.be/standards/fhir/core-clinical/NamingSystem/be-ns-diabetes-device-type",
    "preferred" : true
  }]
}
